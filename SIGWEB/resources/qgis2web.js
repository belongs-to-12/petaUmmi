...
map.getView().fit([11963484.093415, -787562.104818, 12003376.014809, -755100.867239], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lokasi Potensial dalam Ekspansi Bento Kopi di Kota Bandung</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (13 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ummi Kun<br />2024';
            }
